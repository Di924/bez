...
include_once(BASE_PATH . '/classes/Roles.php');

//Get DB instance.
$db = getDbInstance();
$db->where("login", $_SESSION['login']);
$row = $db->get('users');
$image_url = '../img/profile/'.$row[0]['photo'];
$roles = new Roles();
?>
<!-- Main container -->
                ...
                <div class="col col-sm-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-1 text-center">
                            <a href="edit.php?profile_id=<?php echo $row[0]['id']; ?>&role=<?php echo $row[0]['user_role']; ?>&profile_foto=<?php echo $image_url; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i></a>
                        </div>
                    </div>
                    <div class="row">
